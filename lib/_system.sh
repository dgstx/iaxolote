...
system_git_clone() {
  ...
  sleep 2
  sudo su - deploy <<EOF
  git clone https://github.com/dgstx/axolote.git /home/deploy/axolote/
...
system_git_clone_instancia() {
  ...
  sleep 2
  sudo su - deploy <<EOF
  git clone https://github.com/dgstx/axolote.git /home/deploy/$instancia/
...
system_success() {
  ...
  printf "${CYAN_LIGHT}";
  printf "\n\n"
  printf "Usuário: admin@wasap.com.br"
  printf "\n"
  printf "Senha: 123456"
  printf "\n\n"
